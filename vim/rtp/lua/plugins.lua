...
return require('packer').startup(function(use)
  ...
  use {
    ...
    config = function()
      ...
      vim.keymap.set({ "o", "x" }, "iI", '<Cmd>lua require("various-textobjs").indentation(true, false)<CR>',
      ...
      vim.keymap.set({ "o", "x" }, "im", '<Cmd>lua require("various-textobjs").subword(true)<CR>',
        { desc = 'Subword (inner)' })
      ...
      vim.keymap.set('n', '<Leader>g',
        function()
          require('toggleterm.terminal').Terminal:new({
            cmd = 'lazygit',
            direction = 'float',
            float_opts = { width = math.floor(vim.o.columns * 0.95), height = math.floor(vim.o.lines * 0.90) }
          }):toggle()
        end,
        { desc = 'lazygit' })
    end
