...
return {
	...
	},
	{
		...
		keys = {
			{ "<C-n>", mode = { "n", "v", "o" }, desc = "nap next" },
			{ "<C-p>", mode = { "n", "v", "o" }, desc = "nap previous" },
		},
	},
	{
	...
	},
	{
		...
		config = function()
			...
			local keymaps = {
				["aa"] = { "@assignment.outer", { desc = "outer assignment" } },
				["ia"] = { "@assignment.inner", { desc = "inner assignment" } },
				["aA"] = { "@assignment.rhs", { desc = "rhs assignment" } },
				["iA"] = { "@assignment.lhs", { desc = "lhs assignment" } },
				["ab"] = { "@conditional.outer", { desc = "outer conditional" } },
				["ib"] = { "@conditional.inner", { desc = "inner conditional" } },
				["ac"] = { "@call.outer", { desc = "outer call" } },
				["ic"] = { "@call.inner", { desc = "inner call" } },
				["aC"] = { "@class.outer", { desc = "outer class" } },
				["iC"] = { "@class.inner", { desc = "inner class" } },
				["af"] = { "@function.outer", { desc = "outer function" } },
				["if"] = { "@function.inner", { desc = "inner function" } },
				["aF"] = { "@frame.outer", { desc = "outer frame" } },
				["iF"] = { "@frame.inner", { desc = "inner frame" } },
				["ag"] = { "@parameter.outer", { desc = "outer parameter" } },
				["ig"] = { "@parameter.inner", { desc = "inner parameter" } },
				["al"] = { "@loop.outer", { desc = "outer loop" } },
				["il"] = { "@loop.inner", { desc = "inner loop" } },
				["aM"] = { "@comment.outer", { desc = "outer comment" } },
				["iM"] = { "@comment.inner", { desc = "inner comment" } },
				["an"] = { "@return.outer", { desc = "outer return" } },
				["in"] = { "@return.inner", { desc = "inner return" } },
				["iN"] = { "@number.inner", { desc = "inner number" } },
				["ao"] = { "@block.outer", { desc = "outer block" } },
				["io"] = { "@block.inner", { desc = "inner block" } },
				["iP"] = { "@scopename.inner", { desc = "inner scopename" } },
				["iS"] = { "@statement.inner", { desc = "inner statement" } },
				["aT"] = { "@attribute.outer", { desc = "outer attribute" } },
				["iT"] = { "@attribute.inner", { desc = "inner attribute" } },
				["ax"] = { "@regex.outer", { desc = "outer regex" } },
				["ix"] = { "@regex.inner", { desc = "inner regex" } },
			}
			for key, val in pairs(keymaps) do
				vim.keymap.set({ "x", "o" }, key, function()
					require("nvim-treesitter-textobjects.select").select_textobject(val[1], "textobjects")
				end, val[2])
			end
		end,
		event = "VeryLazy",
