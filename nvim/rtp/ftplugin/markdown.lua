...
vim.api.nvim_buf_create_user_command(0, 'ToDoToggleStatus', function(command) todo_toggle_status(command.fargs[1]) end, { nargs = 1 })
...
vim.api.nvim_buf_create_user_command(0, 'ToggleToDoCancelled', function() todo_toggle_cancelled(vim.api.nvim_get_current_line()) end, {})

local function conceal_toggle()
  vim.wo.conceallevel = vim.wo.conceallevel == 0 and 2 or 0
end

vim.api.nvim_buf_create_user_command(0, 'ConcealToggle', function() conceal_toggle() end, {})
...
vim.api.nvim_buf_create_user_command(0, 'ToDoAddPomodoro', function() todo_add_pomodoro() end, {})
